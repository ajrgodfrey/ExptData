...
#' }
#' @source Mead, R. (1988) \emph{The Design of Experiments: Statistical Principles for Practical Applications}, Cambridge University Press. Example 7.10; data found in  Table 7.3 on page 145.
...
#' }
#' @source Mead, R. (1988) \emph{The Design of Experiments: Statistical Principles for Practical Applications}, Cambridge University Press. Example 12.4; data found in  Table 12.13 on page 329. 
#' @author contributed by A. Jonathan R. Godfrey
#' @usage Detergent
NULL
...
#' }
#' @source Mead, R. (1988) \emph{The Design of Experiments: Statistical Principles for Practical Applications}, Cambridge University Press. Example 8.2; data found in Table 8.8 on page 200, and repeated in Table 10.5 on page 254.
#' @author contributed by A. Jonathan R. Godfrey
#' @usage PainRelief
NULL
...
#' }
#' @source Mead, R. (1988) \emph{The Design of Experiments: Statistical Principles for Practical Applications}, Cambridge University Press. Example 7.11; data found in Table 7.7 on page 148.
#' @author contributed by A. Jonathan R. Godfrey
#' @usage Peppers
NULL
...
#' }
#' @source Mead, R. (1988) \emph{The Design of Experiments: Statistical Principles for Practical Applications}, Cambridge University Press. Example 12.3; data found in  Table 12.9 on page 323.
#' @author contributed by A. Jonathan R. Godfrey
#' @usage Turnip
NULL
...
#' }
#' @source Mead, R. (1988) \emph{The Design of Experiments: Statistical Principles for Practical Applications}, Cambridge University Press. Example 11.1; data found in table 11.7 on page 289.
#' @author contributed by A. Jonathan R. Godfrey
#' @usage Vaccine
NULL
